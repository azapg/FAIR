...
from sqlalchemy import String, Text, ForeignKey, UUID as SAUUID, TIMESTAMP, JSON, Table, Column
...
assignment_artifacts = Table(
    ...
    Column("assignment_id", SAUUID, ForeignKey("assignments.id", ondelete="CASCADE"), nullable=False),
...
class Assignment(Base):
    ...
    course_id: Mapped[UUID] = mapped_column(SAUUID, ForeignKey("courses.id"), nullable=False)
    ...
    def __repr__(self) -> str:
        return f"<Assignment id={self.id} title={self.title!r} course_id={self.course_id}>"
